...
======================
使用 PyTorch + EfficientNet-B0 (Transfer Learning) 訓練石頭剪刀布 + Error 四分類模型
...
- 訓練完畢後將模型存至 demo/rps_efficientnet.pth
"""
...
IMG_SIZE     = 224
BATCH_SIZE   = 32
NUM_EPOCHS   = 3  # 保持與 MobileNet 相同的 3 個 Epoch 方便比較
LR           = 1e-4
...
print("=" * 55)
print("  EfficientNet-B0 Rock-Paper-Scissors Training")
print("=" * 55)
...
# ─────────────────────────────────────────────
# 4. 建立 EfficientNet-B0 模型
# ─────────────────────────────────────────────
print("[Step 2] Building EfficientNet-B0 (ImageNet pretrained)...")
...
save_path = os.path.join(DEMO_DIR, 'rps_efficientnet.pth')
